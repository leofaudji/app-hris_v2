...
return [
    ...
    ['type' => 'collapse', 'key' => 'hr_kepegawaian', 'label' => 'Kepegawaian', 'icon' => 'bi bi-people', 'children' => [
        ...
        ['key' => 'hr_dokumen_perusahaan', 'label' => 'Dokumen Perusahaan', 'url' => '/hr/dokumen-perusahaan', 'icon' => 'bi bi-folder2-open'],
        ['key' => 'hr_request_surat', 'label' => 'Request Surat', 'url' => '/hr/request-surat', 'icon' => 'bi bi-envelope-paper'],
    ...
    ['type' => 'collapse', 'key' => 'hr_master', 'label' => 'Master Data HR', 'icon' => 'bi bi-database-gear', 'children' => [
        ...
        ['key' => 'hr_qrcode_generator', 'label' => 'Generator QR Code', 'url' => '/hr/qrcode-generator', 'icon' => 'bi bi-qr-code'],
    ]],
    ...
    ['type' => 'collapse', 'key' => 'portal_karyawan', 'label' => 'Portal Karyawan', 'icon' => 'bi bi-person-workspace', 'children' => [
        ...
        ['key' => 'portal_directory', 'label' => 'Direktori Karyawan', 'url' => '/hr/portal/directory', 'icon' => 'bi bi-person-lines-fill'],
        ['key' => 'portal_kalender', 'label' => 'Kalender Tim', 'url' => '/hr/portal/kalender', 'icon' => 'bi bi-calendar3'],
        ['key' => 'portal_dokumen', 'label' => 'Dokumen & Surat', 'url' => '/hr/portal/dokumen', 'icon' => 'bi bi-file-earmark-text'],
        ['key' => 'portal_pengajuan_cuti', 'label' => 'Pengajuan Cuti', 'url' => '/hr/portal/pengajuan-cuti', 'icon' => 'bi bi-calendar-plus'],
        ['key' => 'portal_lembur', 'label' => 'Lembur', 'url' => '/hr/portal/lembur', 'icon' => 'bi bi-clock-history'],
        ['key' => 'portal_kpi', 'label' => 'Rapor KPI', 'url' => '/hr/portal/kpi', 'icon' => 'bi bi-award'],
